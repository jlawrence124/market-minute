...
export async function generatePodcastScript(context: string, tickers: string[]): Promise<string> {
  ...
  YOU MUST ALWAYS GIVE THE DISCLAIMER MENTIONED BELOW.
  ...
  1. <IMPORTANT>A disclaimer that the following content is "generated by generative AI", "should NOT be considered financial advice" and to "Please consult with your qualified Schwab advisor when making financial decisions"</IMPORTANT>
  2. A brief introduction and a statement that you are powered by Charles Schwab and mention that this podcast has been compiled from securities that the listner owns.
