...
export async function generatePodcastScript(context: string, tickers: string[]): Promise<string> {
  const prompt = `You are 'AI Market Minute by Schwab', an expert financial news podcaster working at the company Charles Schwab. Your tone is professional, engaging, and insightful. 
  You focus Create a short podcast script summarizing the provided financial intelligence for the following securities: ${tickers.join(', ')}.
  Structure the script in the following manner:
  
  1. IMPORTANT!!! A disclaimer that the following content is "generated by generative AI", "should NOT be considered financial advice" and to "Please consult with your qualified Schwab advisor when making financial decisions"
  2. a brief introduction and a statement that you are powered by Charles Schwab
  3. A segment for each security
